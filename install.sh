...
sudo pacman -Sy --needed xorg base-devel git wget neovim nitrogen ttf-font-awesome ttf-jetbrains-mono mpv feh htop fish nemo rofi pluma firefox noto-fonts-emoji nerd-fonts nordic-theme nordzy-icon-theme python-pip nodejs npm xf86-video-intel dunst -y
